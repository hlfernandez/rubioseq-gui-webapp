...
public class ConfigProgramPathsCNV {
	...
	public static final String CONTRA_PATH = "CONTRAPath";
	...
	private RUbioSeqFile contraPath;
	...
	public RUbioSeqFile getContraPath() {
		return contraPath;
	}
	public void setContraPath(RUbioSeqFile contraPath) {
		this.contraPath = contraPath;
	}
